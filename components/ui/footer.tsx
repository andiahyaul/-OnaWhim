    ...
    <footer className="w-full bg-transparent">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col items-center space-y-6">
          {/* Brand Name */}
          <h3 className="text-2xl font-bold" style={{color: '#B5386F'}}>
            Onawhim._
          </h3>
          ...
          <div className="flex items-center space-x-6">
            ...
            >
              <svg
                className="w-6 h-6 transition-colors duration-300 group-hover:scale-110 transform"
                style={{color: '#B5386F'}}
                fill="currentColor"
                viewBox="0 0 24 24"
                aria-hidden="true"
          ...
          <div className="text-center">
            <p className="text-sm font-inter" style={{color: '#B5386F'}}>
